  ...
  <body>
	...
	<div class="container test">
			...
			<form action="/write" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label for="customer_code">작성자</label> <input type="text"
						class="form-control" id="customer_code" placeholder="작성자(2자-10자)"
						name="customer_code">
				</div>
				...
				<label for ="upload"> 첨부파일 <input type="file" name="filename" id="filepath">
				</label> <br>
