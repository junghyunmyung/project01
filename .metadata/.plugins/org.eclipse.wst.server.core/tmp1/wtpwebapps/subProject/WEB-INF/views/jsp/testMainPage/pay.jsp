	...
	<form action = "/payment" method="post">
      <section>
        <div class="right" data-v-33033856="" data-v-52175841="">
          ...
          <input type="hidden" name = "mem_code" id = "mem_code" value="${payPage.mem_code}">
          <input type="hidden" name = "hotel_code" id = "hotel_code" value="${payPage.hotel_code}">
          <input type="hidden" name = "room_code" id = "room_code" value="${payPage.room_code}">
          
          <input type="hidden" name = "room_code" id = "name" value="${payPage.name}">
          <input type="hidden" name = "room_code" id = "room_name" value="${payPage.room_name}">
          <input type="hidden" name = "room_code" id = "days" value="${payPage.days}">
          <input type="hidden" name = "room_code" id = "totalPrice" value="${payPage.totalPrice}">
          
   		  <input type="hidden" name = "checkin" id = "checkin" value="${searchDTO.checkin}">
   		  <input type="hidden" name = "checkout" id = "checkout" value="${searchDTO.checkout}">
          
         <!--  <input type = "hidden" name = "checkin" value= "date_in">
          <input type = "hidden" name = "checkout" value= "date_out"> -->
          ...
          <button type ="button" onclick = "apibtn()"><img src = "/resources/imagesKakao/kakao_pay.png"/></button>
        </div>
