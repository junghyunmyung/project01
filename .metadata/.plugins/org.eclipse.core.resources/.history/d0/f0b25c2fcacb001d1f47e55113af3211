...
public class KakaoCancelResponse {
	 ...
	 private String aid; // 요청 고유 번호
	    ...
	    public KakaoCancelResponse(String aid, String tid, String cid, String status, String partner_order_id,
				String partner_user_id, String payment_method_type, Amount amount,
				ApprovedCancelAmount approved_cancel_amount, CanceledAmount canceled_amount,
				CancelAvailableAmount cancel_available_amount, String item_name, String item_code, int quantity,
				String created_at, String approved_at, String canceled_at, String payload) {
			this.aid = aid;
			this.tid = tid;
			this.cid = cid;
			this.status = status;
		...
		public String toString() {
			return "KakaoCancelResponse [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", status=" + status
					+ ", partner_order_id=" + partner_order_id + ", partner_user_id=" + partner_user_id
					+ ", payment_method_type=" + payment_method_type + ", amount=" + amount
					+ ", approved_cancel_amount=" + approved_cancel_amount + ", canceled_amount=" + canceled_amount
					+ ", cancel_available_amount=" + cancel_available_amount + ", item_name=" + item_name
