...
public class ApprovedCancelAmount {
	...
	public ApprovedCancelAmount(int total, int tax_free, int vat, int point, int discount, int green_deposit) {
		this.total = total;
	...
	public String toString() {
		return "ApprovedCancelAmount [total=" + total + ", tax_free=" + tax_free + ", vat=" + vat + ", point=" + point
