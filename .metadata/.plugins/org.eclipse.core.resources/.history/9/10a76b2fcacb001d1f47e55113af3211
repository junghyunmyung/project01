...
public class KakaoApproveResponse {
    ...
    public KakaoApproveResponse(String aid, String tid, String cid, String sid, String partner_order_id,
			String partner_user_id, String payment_method_type, Amount amount, String item_name, String item_code,
			int quantity, String created_at, String approved_at, String payload) {
		this.aid = aid;
		this.tid = tid;
		this.cid = cid;
		this.sid = sid;
	...
	public String toString() {
		return "KakaoApproveResponse [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid
