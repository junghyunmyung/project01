...
public class BoardFreePageDTO {
	...
	public BoardFreePageDTO() {

	}

	public BoardFreePageDTO(int currentPage, int totalCount) {
	...
	public BoardFreePageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
	...
	public String toString() {
		return "BoardFreePageDTO [currentPage=" + currentPage + ", totalCount=" + totalCount + ", blockCount="
				+ blockCount + ", blockPage=" + blockPage + ", totalPage=" + totalPage + ", startRow=" + startRow
				+ ", endRow=" + endRow + ", startPage=" + startPage + ", endPage=" + endPage + ", number=" + number
