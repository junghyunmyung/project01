...
// http://localhost:8090/test/test/test
...
public class TestController {
	...
	@Autowired
	public TestController(CrawligService service) {
...
//	      listRating.forEach(n->System.out.println(n));
	      ...
	      for(int i=0; i<e1.size(); i++) {
	    	  ...
	    	  Element e2 = e1.get(i);
	    	  	...
	    	  	//호텔 사진
	    	  	String filename = e2.attr("class", "pic").select("img").attr("data-original");
